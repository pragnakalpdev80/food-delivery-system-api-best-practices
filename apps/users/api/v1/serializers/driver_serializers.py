...
from common.utils.validators import validate_image_format, validate_image_size_5mb
...
class DriverProfileSerializer(serializers.ModelSerializer):
    ...
    avatar = serializers.ImageField(
        validators=[validate_image_format, validate_image_size_5mb], required=False
    )
