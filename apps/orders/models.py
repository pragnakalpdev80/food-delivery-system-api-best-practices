...
class Cart(TimestampedModel):
    ...
    customer = models.OneToOneField(
        CustomerProfile, on_delete=models.CASCADE, related_name="cart"
    )
...
class CartItem(TimestampedModel):
    ...
    menu_item = models.ForeignKey(
        MenuItem, on_delete=models.CASCADE, related_name="added_item"
    )
...
class Order(TimestampedModel):
    ...
    customer = models.ForeignKey(
        CustomerProfile, on_delete=models.CASCADE, related_name="order", db_index=True
    )
    restaurant = models.ForeignKey(
        Restaurant, on_delete=models.CASCADE, related_name="orders", db_index=True
    )
...
class Review(TimestampedModel):
    ...
    customer = models.ForeignKey(
        CustomerProfile, on_delete=models.CASCADE, db_index=True, related_name="review"
    )
    restaurant = models.ForeignKey(
        Restaurant, on_delete=models.CASCADE, null=True, db_index=True
    )
